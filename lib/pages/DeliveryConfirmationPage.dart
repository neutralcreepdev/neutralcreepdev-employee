            ...
            return Container(
              ...
              child: Column(
                children: <Widget>[
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                          Text("Delivery\nConfirmation",style: TextStyle(fontSize: 55),),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              SizedBox(height: 25,),
                              IconButton(icon: icon, iconSize: MediaQuery.of(context).size.width*0.2,)
                            ],
                          ),
                        ),
                      )),
                  Expanded(
                    flex: 2,
                    child: Container(color: Theme.of(context).canvasColor,child: Align(
                      alignment: Alignment.topCenter,
                      child: Container(
                        width: MediaQuery.of(context).size.width * 0.9,
                        height: MediaQuery.of(context).size.height * 0.07,
                        child: FlatButton(
                          color: delivered != false ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
