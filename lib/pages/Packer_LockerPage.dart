...
class PackerLockerPageWidget extends StatefulWidget {
  ...
  @override
  _PackerLockerPageWidgetState createState() =>
      _PackerLockerPageWidgetState(employee: employee, order: order, edb: edb);
}
...
class _PackerLockerPageWidgetState extends State<PackerLockerPageWidget> {
  ...
  void enteredLockerNum(BuildContext context) async {
    if (lockerNum) {
      ...
      Fluttertoast.showToast(msg: "Please enter a valid locker number!");
    }
  }

  bool lockerCheck(String lockerNum) {
    bool temp = true;
    if (lockerNum.length == 0 ||
        lockerNum.isEmpty ||
        lockerNum == "" ||
        lockerNum == null) temp = false;
